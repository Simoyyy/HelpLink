...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String _selectedRole = AppConstants.roleBeneficiary;
  ...
  Future<void> _handleLogin() async {
    ...
    if (success) {
      final route = _selectedRole == AppConstants.roleDonor
          ? '/donor-dashboard'
              ...
              children: [
                ...
                Row(
                  children: [
                    _RoleChip(
                      label: 'Beneficiary',
                      isSelected: _selectedRole == AppConstants.roleBeneficiary,
                      onTap: () => setState(() => _selectedRole = AppConstants.roleBeneficiary),
