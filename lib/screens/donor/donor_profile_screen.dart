...
class _DonorProfileScreenState extends State<DonorProfileScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _divider(),
                          _emailField(email: user.email, accentColor: AppTheme.primaryBlue),
                          _divider(),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _accountInfoRow('Account Type', 'Donor'),
                          const SizedBox(height: 8),
  ...
  Future<void> _showEmailChangeSheet(String currentEmail, Color accentColor) async {
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                Text(
                  step2 ? 'Enter Verification Code' : 'Change Email Address',
                  style: const TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.bold,
                      color: AppTheme.textDark),
